---
title: TaamAI CHAT Environment Variables - Customizing Guide
description: >-
  Learn how to customize TaamAI CHAT configuration using environment variables for
...
TaamAI CHAT provides some additional configuration options when deployed, which can be customized using environment variables.
...
without forking the entire TaamAI CHAT repository. Here's a guide on how to do this:
...
"Build Custom TaamAI CHAT Image" workflow.

This approach allows you to create a custom build with your desired NEXT_PUBLIC variables without maintaining
a full fork of the TaamAI CHAT repository. You can trigger a new build whenever you need to update your custom image.
