---
title: Deploy TaamAI CHAT with Docker
description: >-
  Learn how to deploy the TaamAI CHAT service using Docker, including installation
...
We provide a [Docker image][docker-release-link] for you to deploy the TaamAI CHAT service on your private device.
...
Use the following command to start the TaamAI CHAT service with one click:
...
- For the complete list of environment variables supported by TaamAI CHAT, please refer to the [Environment Variables](/docs/self-hosting/environment-variables) section.
