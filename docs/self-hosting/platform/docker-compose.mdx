---
title: Deploy TaamAI CHAT with Docker Compose
description: >-
  Learn how to deploy the TaamAI CHAT service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the TaamAI CHAT service on your private device.
