---
title: Deploy TaamAI CHAT using aaPanel
description: Learn how to deploy the TaamAI CHAT service using aaPanel-Docker, including installing the Docker container environment and using the command to start the service with one click. Detailed instructions on how to configure environment variables and use proxy addresses.
tags:
  - Docker
  - TaamAI CHAT
...
3. After the installation is complete, find `TaamAI CHAT` in `One-Click Install` and click `install`  
![install-TaamAI CHAT](https://github.com/user-attachments/assets/9f989104-bb8e-4acd-9721-6b1db1017d2b)
...
![addTaamAI CHAT](https://github.com/user-attachments/assets/f0b2e72d-9eee-46a8-b094-4834b78764df)
5. After installation, enter the domain name or IP+ port set in the previous step in the browser to access.
- Name: application name, default `TaamAI CHAT-random characters`
...
## Visit TaamAI CHAT
- If you have set a domain name, please directly enter the domain name in the browser address bar, such as `http://demo.TaamAI CHAT`, to access the `TaamAI CHAT` console.
