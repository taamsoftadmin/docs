---
title: Configuring Github Authentication Service for TaamAI CHAT
description: >-
  Learn how to configure Github authentication service for TaamAI CHAT, including
...
| `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for TaamAI CHAT. Use `github` for Github. |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use TaamAI CHAT.
</Callout>
