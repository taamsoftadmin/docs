---
title: Deploy TaamAI CHAT with Database on RepoCloud
description: Learn how to deploy TaamAI CHAT on RepoCloud with ease, including: database, authentication and S3 storage service.
tags:
  - Deploy TaamAI CHAT
...
# Deploying TaamAI CHAT Database Edition with RepoCloud

If you want to deploy TaamAI CHAT Database Edition on RepoCloud, you can follow the steps below:
