---
title: Translation of Conversation Records - TaamAI CHAT
description: >-
  Learn how to translate conversation content in TaamAI CHAT with just one click.
...
TaamAI CHAT supports users to translate conversation content into a specified language with just one click. After selecting the target language, TaamAI CHAT will use a pre-set AI model for translation and display the translated results in real-time in the chat window.
