---
title: Using Stepfun API Key in TaamAI CHAT
description: >-
  Learn how to integrate Stepfun AI models into TaamAI CHAT for engaging
  conversations. Obtain Stepfun API key, configure Stepfun in TaamAI CHAT settings,
...
# Using Stepfun in TaamAI CHAT

<Image
  alt={'Using Stepfun in TaamAI CHAT'}
  cover
...
This document will guide you on how to use Stepfun in TaamAI CHAT:
...
### Step 2: Configure Stepfun in TaamAI CHAT
...
You can now use the models provided by Stepfun to have conversations in TaamAI CHAT.
