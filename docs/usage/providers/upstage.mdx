---
title: Using Upstage in TaamAI CHAT
description: Learn how to integrate and utilize Upstage's language model APIs in TaamAI CHAT.
tags:
  - TaamAI CHAT
  - Upstage
  - API Key
...
This article will guide you on how to use Upstage in TaamAI CHAT.
...
### Step 2: Configure Upstage in TaamAI CHAT
...
You can now use the models provided by Upstage for conversations in TaamAI CHAT.
