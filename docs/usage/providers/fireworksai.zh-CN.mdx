---
title: 在 TaamAI CHAT 中使用 Fireworks AI
description: 学习如何在 TaamAI CHAT 中配置和使用 Fireworks AI 的API Key，以便开始对话和交互。
tags:
  - TaamAI CHAT
  - Fireworks AI
  - API密钥
...
# 在 TaamAI CHAT 中使用 Fireworks AI
...
本文将指导你如何在 TaamAI CHAT 中使用 Fireworks AI。
...
### 步骤二：在 TaamAI CHAT 中配置 Fireworks AI
...
至此你已经可以在 TaamAI CHAT 中使用 Fireworks AI 提供的模型进行对话了。
