---
title: Using Taichu API Key in TaamAI CHAT
description: >-
  Learn how to integrate Taichu AI into TaamAI CHAT for enhanced conversational
...
# Using Taichu in TaamAI CHAT

<Image
  alt={'Using Taichu in TaamAI CHAT'}
  cover
  src={'https://github.com/user-attachments/assets/9cb27b68-f2ac-4ff9-8f97-d96314b1af03'}
/>

This article will guide you on how to use Taichu in TaamAI CHAT:
...
### Step 2: Configure Taichu in TaamAI CHAT
...
Now you can start conversing with the models provided by Taichu in TaamAI CHAT.
