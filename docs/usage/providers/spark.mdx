---
title: Using iFLYTEK Spark in TaamAI CHAT
description: Learn how to integrate and utilize iFLYTEK's Spark model APIs in TaamAI CHAT.
tags:
  - TaamAI CHAT
  - iFLYTEK
  - Spark
  ...
  - Web UI
---
# Using iFLYTEK Spark in TaamAI CHAT
...
This guide will instruct you on how to use iFLYTEK Spark in TaamAI CHAT.
...
### Step 2: Configure iFLYTEK Spark in TaamAI CHAT

- Access the `Settings` menu in TaamAI CHAT
...
Now you can use the models provided by iFLYTEK Spark for conversations in TaamAI CHAT.
