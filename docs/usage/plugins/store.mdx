---
title: TaamAI CHAT Plugin Store
description: >-
  Learn how to access the Plugin Store in TaamAI CHAT to easily install and use
...
In the plugin store, you can directly install and use plugins in TaamAI CHAT.
