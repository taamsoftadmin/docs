---
title: Enhance Your TaamAI CHAT Assistant with Plugins
description: >-
  Learn how to expand your TaamAI CHAT assistant's capabilities by enabling and
...
The plugin system is a key element in expanding the capabilities of assistants in TaamAI CHAT. You can enhance the assistant's abilities by enabling a variety of plugins.

Watch the following video to quickly get started with using TaamAI CHAT plugins:
...
The Plugin Store allows you to directly install and use plugins within TaamAI CHAT.
