---
title: Customizing Provider Model List in TaamAI CHAT for Deployment
description: >-
  Learn how to customize the model list in TaamAI CHAT for deployment with the
...
TaamAI CHAT supports customizing the model list during deployment. This configuration is done in the environment for each [model provider](/docs/self-hosting/environment-variables/model-provider). 
