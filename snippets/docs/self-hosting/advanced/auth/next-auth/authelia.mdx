---
title: Configuring Authelia Authentication Service for TaamAI CHAT
description: >-
  Learn how to configure Authelia authentication service in TaamAI CHAT, including
  creating a provider, configuring environment variables, and deploying
  TaamAI CHAT. Detailed steps and necessary environment variable settings.
tags:
...
We assume you are already familiar with using Authelia. Let's say your TaamAI CHAT instance is deployed at https://lobe.example.com/.
...
Note! The secret configured in Authelia is ciphertext, i.e., a salted hash value. Its corresponding plaintext needs to be filled in TaamAI CHAT later.
