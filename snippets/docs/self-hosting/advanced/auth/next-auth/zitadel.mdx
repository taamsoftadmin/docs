---
title: Configure ZITADEL Authentication Service for TaamAI CHAT
description: >-
  Learn how to configure ZITADEL Authentication Service for TaamAI CHAT deployment,
  including creating ZITADEL applications, setting up environment variables, and
  enabling single sign-on (SSO).
tags:
  - ZITADEL Authentication
  - TaamAI CHAT Deployment
  - Single Sign-On (SSO)
...
- Replace `http(s)://your-domain` with the actual URL that TaamAI CHAT is deployed to.
...
<Callout>
  After successful deployment, users will be able to authenticate and use TaamAI CHAT using existing
