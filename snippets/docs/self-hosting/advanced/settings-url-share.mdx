...
description: >-
  Learn how to import and export configuration settings for TaamAI CHAT via URL.
...
TaamAI CHAT support import settings from external URL to quickly set up TaamAI CHAT configuration.
...
```plaintext
https://taam.cloud/?settings=<settings object in JSON format>
https://taam.cloud/?settings={"keyVaults":{"openai":{"apiKey":"user-key","baseURL":"https://your-proxy.com/v1"}}}
```
...
<Callout type={'warning'}>
  TaamAI CHAT does not verify the correctness of the settings parameters in the URL, nor provide
