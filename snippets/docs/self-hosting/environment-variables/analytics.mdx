---
title: Integrating Analytics in TaamAI CHAT
description: >-
  Learn how to configure environment variables for Vercel Analytics, Google
  Analytics, PostHog Analytics, and Umami Analytics in TaamAI CHAT for data
...
We have integrated several free/open-source data analytics services in TaamAI CHAT for collecting user usage data. Here are environment variables that you can use.
