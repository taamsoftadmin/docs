---
title: Deploy TaamAI CHAT on Zeabur
description: >-
...
# Deploy TaamAI CHAT with Zeabur

If you want to deploy TaamAI CHAT on Zeabur, you can follow the steps below:
...
# Deploy TaamAI CHAT with Zeabur as serverless function
...
Since Zeabur does NOT officially support FREE users deploy containerized service, you may wish to deploy TaamAI CHAT as a serverless function service. To deploy TaamAI CHAT as a serverless function service on Zeabur, you can follow the steps below:
...
### Link your fork of TaamAI CHAT to the just created Zeabur service.
