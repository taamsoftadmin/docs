---
title: Deploy TaamAI CHAT with Netlify - Step-by-Step Guide
description: >-
  Learn how to deploy TaamAI CHAT on Netlify with detailed instructions on forking
...
# Deploy TaamAI CHAT with Netlify

If you want to deploy TaamAI CHAT on Netlify, you can follow these steps:

## Deploy TaamAI CHAT with Netlify

<Steps>
  ### Fork the TaamAI CHAT Repository

Click the Fork button to fork the TaamAI CHAT repository to your GitHub account.
...
Next, select the TaamAI CHAT project:

<Image
  alt={'Select the TaamAI CHAT github project'}
  height={228}
  inStep
...
<Image
  alt={'Configure TaamAI CHAT site name'}
  height={712}
  inStep
...
<Image
  alt={'Add TaamAI CHAT site environment variables'}
  height={537}
  inStep
...
<Callout type={'tip'}>
  For a complete list of environment variables supported by TaamAI CHAT, please refer to the [📘
...
Upon entering the deployment details, you will see the following interface, indicating that your TaamAI CHAT is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'TaamAI CHAT deployment in progress'}
  height={325}
  inStep
...
If your Deploy Log in the interface looks like the following, it means your TaamAI CHAT has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your TaamAI CHAT site.

  <Image alt={'Access Your TaamAI CHAT Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
