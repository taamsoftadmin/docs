---
title: Using Qwen2 API Key in TaamAI CHAT
description: >-
  Learn how to integrate and utilize Tongyi Qianwen, a powerful language model
  by Alibaba Cloud, in TaamAI CHAT for various tasks. Follow the steps to activate
...
# Using Tongyi Qianwen in TaamAI CHAT

<Image
  alt={'Using Tongyi Qianwen in TaamAI CHAT'}
  cover
...
This document will guide you on how to use Tongyi Qianwen in TaamAI CHAT:
...
### Step 3: Configure Tongyi Qianwen in TaamAI CHAT
...
You can now engage in conversations using the models provided by Tongyi Qianwen in TaamAI CHAT.
