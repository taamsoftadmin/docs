---
title: Using Novita AI API Key in TaamAI CHAT
description: >-
  Learn how to integrate Novita AI's language model APIs into TaamAI CHAT. Follow
...
# Using Novita AI in TaamAI CHAT

<Image
  alt={'Using Novita AI in TaamAI CHAT'}
  cover
...
This document will guide you on how to integrate Novita AI in TaamAI CHAT:
...
You can now engage in conversations using the models provided by Novita AI in TaamAI CHAT.
