---
title: Using Minimax API Key in TaamAI CHAT
description: >-
  Learn how to use MiniMax in TaamAI CHAT to enhance AI conversations. Obtain
  MiniMax API key, configure MiniMax in TaamAI CHAT settings, and select a model
...
# Using Minimax in TaamAI CHAT

<Image
  alt={'Using Minimax in TaamAI CHAT'}
  cover
...
This document will guide you on how to use Minimax in TaamAI CHAT:
...
### Step 2: Configure MiniMax in TaamAI CHAT

- Go to the `Settings` interface of TaamAI CHAT
...
You can now use the models provided by MiniMax to have conversations in TaamAI CHAT.
