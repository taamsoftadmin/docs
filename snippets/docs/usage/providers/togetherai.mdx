---
title: Using Together AI in TaamAI CHAT API Key
description: >-
  Learn how to integrate Together AI into TaamAI CHAT, obtain the API key,
...
# Using Together AI in TaamAI CHAT

<Image
  alt={'Using Together AI in TaamAI CHAT'}
  cover
...
This document will guide you on how to use Together AI in TaamAI CHAT:
...
You can now engage in conversations using the models provided by Together AI in TaamAI CHAT.
