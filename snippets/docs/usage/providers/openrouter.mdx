---
title: Using OpenRouter API Key in TaamAI CHAT
description: >-
  Learn how to integrate and utilize OpenRouter's language model APIs in
  TaamAI CHAT. Follow these steps to register, create an API key, recharge credit,
...
# Using OpenRouter in TaamAI CHAT

<Image
  alt={'Using OpenRouter in TaamAI CHAT'}
  cover
...
This document will guide you on how to use OpenRouter in TaamAI CHAT:
...
- Name your API key in the pop-up dialog, for example, "TaamAI CHAT Key"
...
### Step 4: Configure OpenRouter in TaamAI CHAT

- Visit the `Settings` interface in TaamAI CHAT
- Find the setting for `OpenRouter` under `Language Models`
- Enable OpenRouter and enter the API key you obtained

<Image
  alt={'Configure OpenRouter in TaamAI CHAT'}
  height={518}
  inStep
...
You can now engage in conversations using the models provided by OpenRouter in TaamAI CHAT.
