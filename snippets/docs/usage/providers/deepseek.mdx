---
title: Using DeepSeek API Key in TaamAI CHAT
description: >-
  Learn how to use DeepSeek-V2 in TaamAI CHAT, obtain API keys. Get started with
...
# Using DeepSeek in TaamAI CHAT

<Image
  alt={'Using DeepSeek in TaamAI CHAT'}
  cover
...
This document will guide you on how to use DeepSeek in TaamAI CHAT:
...
### Step 2: Configure DeepSeek in TaamAI CHAT

- Access the `App Settings` interface in TaamAI CHAT.
...
You can now engage in conversations using the models provided by Deepseek in TaamAI CHAT.
