---
title: Using Azure OpenAI API Key in TaamAI CHAT
description: >-
  Learn how to integrate and configure Azure OpenAI in TaamAI CHAT to enhance your
...
# Using Azure OpenAI in TaamAI CHAT

<Image
  alt={'Azure OpenAI in TaamAI CHAT'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/5efa34c2-6523-43e6-9ade-70ab5d802e13'}
/>

This document will guide you on how to use [Azure OpenAI](https://oai.azure.com/) in TaamAI CHAT:
...
### Step 2: Configure Azure OpenAI in TaamAI CHAT
...
Now you can engage in conversations using the models provided by Azure OpenAI in TaamAI CHAT.
