---
title: Using Amazon Bedrock API Key in TaamAI CHAT
description: >-
  Learn how to integrate Amazon Bedrock models into TaamAI CHAT for AI-powered
...
# Using Amazon Bedrock in TaamAI CHAT

<Image
  alt={'Using Amazon Bedrock in TaamAI CHAT'}
  cover
...
This document will guide you on how to use Amazon Bedrock in TaamAI CHAT:
...
You can now engage in conversations using the models provided by Amazon Bedrock in TaamAI CHAT.
