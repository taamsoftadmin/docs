---
title: 在 TaamAI CHAT 中使用百川 API Key
description: 学习如何在 TaamAI CHAT 中配置和使用百川的API Key，以便开始对话和交互。
tags:
  - TaamAI CHAT
  - 百川
  - 百川智能
...
至此你已经可以在 TaamAI CHAT 中使用百川提供的模型进行对话了。
