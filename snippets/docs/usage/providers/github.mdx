---
title: Using GitHub Models in TaamAI CHAT
description: Learn how to integrate and utilize GitHub Models in TaamAI CHAT.
tags:
  - TaamAI CHAT
  - GitHub
  - GitHub Models
  ...
  - Web UI
---
# Using GitHub Models in TaamAI CHAT
...
This article will guide you on how to use GitHub Models in TaamAI CHAT.
...
### Step 2: Configure GitHub Models in TaamAI CHAT

- Navigate to the `Settings` interface in TaamAI CHAT.
...
You are now ready to use the models provided by GitHub for conversations within TaamAI CHAT.
