---
title: Plugin System in TaamAI CHAT
description: >-
  Explore the diverse plugin ecosystem of TaamAI CHAT, extending its capabilities
...
The plugin ecosystem of TaamAI CHAT is an important extension of its core functionality, greatly enhancing the practicality and flexibility of the TaamAI CHAT assistant.

<Video src="https://github.com/lobehub/lobe-chat/assets/28616219/f29475a3-f346-4196-a435-41a6373ab9e2" />

By utilizing plugins, TaamAI CHAT assistants can obtain and process real-time information, such as searching for web information and providing users with instant and relevant news.
...
- [lobe-chat-plugins][lobe-chat-plugins]: This is the plugin index for TaamAI CHAT. It retrieves the list of plugins from the index.json of this repository and displays them to the users.
...
- [@lobehub/chat-plugin-sdk][chat-plugin-sdk]: The TaamAI CHAT plugin SDK can help you create excellent Lobe Chat plugins.
- [@lobehub/chat-plugins-gateway][chat-plugins-gateway]: The TaamAI CHAT plugin gateway is a backend service that serves as the gateway for TaamAI CHAT plugins. We deploy this service using Vercel.

### Roadmap Progress

The plugin system of TaamAI CHAT has now entered a stable stage, and we have basically completed most of the functionality required by the plugin system. However, we are still planning and considering the new possibilities that plugins can bring to us. You can learn more in the following Issues:
