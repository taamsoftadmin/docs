...
description: >-
  Explore how TaamAI CHAT integrates visual recognition capabilities into large
...
The ecosystem of large language models that support visual recognition is becoming increasingly rich. Starting from `gpt-4-vision`, TaamAI CHAT now supports various large language models with visual recognition capabilities, enabling TaamAI CHAT to have multimodal interaction capabilities.
